  ...
  <div class="container">
    ...
    >
      <ul class="carousel_body" ref="carousel_body">
        ...
        >
          <img
            :src="carousel.cover_img"
            alt=""
          />
          <div class="slider_content">
            <div class="post_info">NBA</div>
            ...
            <div class="post_authorInfo">
              <span
                ...
                >{{ carousel.author_name }}</span
              >
              <span
                ><i class="iconfont icon-shizhong"></i
                >{{ getPubTime(carousel.pub_date) }}</span
              >
              <span
                ><i class="iconfont icon-yanjing"></i
                >{{ carousel.read_count }}</span
              >
              <i class="redline"></i>
              <i class="fline"></i>
            </div>
            <div class="post_text">
              {{ htmlToText(carousel.content) }}
            </div>
            <div class="read_more" @click="goDetail(carousel.article_id)">阅读原文</div>
          </div>
        </li>
      </ul>
